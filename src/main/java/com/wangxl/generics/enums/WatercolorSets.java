package com.wangxl.generics.enums;//: generics/WatercolorSets.java

import java.util.EnumSet;
import java.util.Set;

import static com.wangxl.generics.enums.Watercolors.*;
import static com.wangxl.net.mindandview.util.Sets.*;
